...
`image #image src=wc:Monument_Valley,_Utah,_USA.jpg caption="Monument Valley" .right .shadow aspect=1.33`
...
`map #map location=Q192017,5 caption="Monument Valley" .right .shadow`
